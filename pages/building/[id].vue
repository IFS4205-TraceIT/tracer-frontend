...
const { data: buildinglogs, refresh } = await useApi(`/building/${route.params.id}`);
    ...
    <div class="container flex w-full mx-auto my-4">
        <div class="overflow-x-auto w-full relative shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr v-for="(log, index) in buildinglogs"
            ...
            <div v-if="buildinglogs && (buildinglogs as Array<any>).length === 0"
